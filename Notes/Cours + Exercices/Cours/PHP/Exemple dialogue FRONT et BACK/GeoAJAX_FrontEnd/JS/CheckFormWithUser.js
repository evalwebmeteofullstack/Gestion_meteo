...
(function() {
	...
	document.getElementById("resbtn").addEventListener("click", resStyles);
...
function afficherListeVilles(rep) {
	...
	for (var i = 0; i < lstVilles.length; i++) {
		...
		monOption.text = maVille.codesPostaux + " - " + maVille.nom;
		monOption.value = maVille.code;
...
function envoyerFormulaire() {
	...
	maReq.send(
			...
			'&city=' 		+ document.getElementById("villes").value);
